...
function Hero() {
  return (
    <div className='mt-28 flex flex-col justify-center items-center text-center'>
        ...
        <h2 className='mt-7 text-[17px] text-grey w-80 sm:text-lg sm:w-[490px] md:text-xl md:w-[570px] lg:w-[710px]'>I’m a Freelance <span className='text-grey'>Front End Developer</span> who enjoys crafting high-performing 
